...
| Repository delivery, review evidence, status fencing, and ruleset audit | `scripts/lib/review-gate.mjs`, `tests/review-gate.test.mjs`, `tests/repository-health.test.mjs` |
