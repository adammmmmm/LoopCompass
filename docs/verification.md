...
| Schema-1 coordinator/action-owner compatibility and consumer-state byte identity | `fixtures/ownership-probe/cases.json`, `scripts/ownership-probe.mjs`, `tests/ownership-probe.test.mjs` |
